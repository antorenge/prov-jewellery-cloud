...
from apps.shared.audit_log import registration, settings
from .models import fields
from .models.managers import AuditLogManager
...
class UserLoggingMiddleware(MiddlewareMixin):
    def process_request(self, request):
        ...
        if not request.method in ('GET', 'HEAD', 'OPTIONS', 'TRACE'):
            ...
            signals.post_save.connect(update_post_save_info,  dispatch_uid=(
                self.__class__, request,), weak=False)
